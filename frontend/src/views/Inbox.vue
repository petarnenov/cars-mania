...
li { padding: .5rem; cursor: pointer; border-radius: 8px; border: 1px solid transparent; border-left: 4px solid transparent; display: flex; justify-content: space-between; align-items: center; gap: .5rem; transition: background .15s ease, border-color .15s ease, color .15s ease; }
...
.bubble { background: #f1f5f9; color: #0f172a; padding: .5rem .6rem; border-radius: 12px; border: 1px solid #e2e8f0; }
